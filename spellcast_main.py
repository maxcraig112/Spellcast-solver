...
if __name__ == "__main__":
    ...
    words = prune_words("ogaotbyolttrsekiatwefmoeg",["gyrates"])
    s = spellcast("ogaotbyolttrsekiatwefmoeg","0110000110111001100001000",(0,0),2,(0,0))
    s.is_viable_word("gyrates")
    print(words)
    # word = "cat"
    ...
    #         if None not in x:
    #             print(word, x, s.get_word_score(x[0]))
